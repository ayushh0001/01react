    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="mb-7">
            <h1 className="text-2xl md:text-3xl font-bold mb-1">Seller Help &amp; Support</h1>
            <p className="text-gray-500">Find answers to common questions or contact our support team for assistance.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            {helpTopics.map((topic, idx) => (
              <div key={idx} className="flex items-start bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                ...
                <div>
                  <h3 className="text-base font-bold mb-1 text-gray-900">{topic.title}</h3>
                  <div className="text-gray-500 text-sm">{topic.description}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
            <h2 className="text-md font-bold text-blue-700 mb-3 flex items-center">
              <svg className="w-5 h-5 mr-2 text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M21 10a9 9 0 11-18 0 9 9 0 0118 0z"/><path d="M9 10h.01M15 10h.01M7 16h10" />
              </svg>
              Contact Support
            </h2>
            <div className="space-y-3">
              <div className="flex items-center text-gray-600">
                ...
                <strong className="mr-1">Live Chat:</strong> Get instant support from our support team.
              </div>
              <div className="flex items-center text-gray-600">
                ...
                <strong className="mr-1">Phone Support:</strong> Speak directly with a support specialist.
              </div>
              <div className="flex items-center text-gray-600">
                <svg className="w-5 h-5 mr-2 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path d="M3 8l9 6 9-6" /><path d="M21 8v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8" />
                </svg>
                <strong className="mr-1">Email Support:</strong> <span className="text-blue-700 hover:underline">support@example.com</span>
              </div>
            </div>
          </div>
        </div>
