        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              ...
              <div>
                {/* Main image */}
                <div className="w-full h-64 rounded-2xl overflow-hidden bg-gray-200 mb-4 cursor-pointer" onClick={() => setShowImageModal(true)}>
                ...
                <div className="flex gap-3 overflow-x-auto pb-2">
                  {product.images && product.images.length > 0 ? (
                    product.images.map((image, index) => (
                      <div 
                        key={index} 
                        className={`flex-shrink-0 w-16 h-16 rounded-xl overflow-hidden cursor-pointer transition-all ${
                    ...
                    <div className="w-16 h-16 rounded-xl overflow-hidden bg-gray-100 flex items-center justify-center text-gray-400 text-xl cursor-pointer">
                      +
                    </div>
                  )}
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    type="button"
                    onClick={handleEdit}
                    className="flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-yellow-400 text-gray-900 text-sm font-semibold shadow-sm hover:bg-yellow-500"
                  >
                    <span>✏️</span>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-green-500 text-white text-sm font-semibold shadow-sm hover:bg-green-600"
                  >
                    <span>✅</span>
